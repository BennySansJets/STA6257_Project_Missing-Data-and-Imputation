...
![Multiple Imputation Process](MultiImputation.jpg)   
...
Chronic_Conditions_STA6707_07132023 <- read_excel("Chronic_Conditions_STA6707_07132023.xlsx")
...
plot_pattern(Chronic_Conditions_STA6707_07132023)
aggr_plot <- aggr(Chronic_Conditions_STA6707_07132023, col=c('navyblue','red'), 
                  numbers=TRUE, sortVars=TRUE, labels=names(data), cex.axis=.7, gap=3, 
                  ylab=c("Histogram of missing data","Pattern"))

```
Figures 1 and 2: Missing Map and histogram 
...
mice_imputed <- data.frame(
  original = Chronic_Conditions_STA6707_07132023$PrvInc,
  imputed_pmm = complete(mice(Chronic_Conditions_STA6707_07132023, method = "pmm"))$PrvInc,
  imputed_cart = complete(mice(Chronic_Conditions_STA6707_07132023, method = "cart"))$PrvInc,
  imputed_lasso = complete(mice(Chronic_Conditions_STA6707_07132023, method = "lasso.norm"))$PrvInc
)
...
aggr(Chronic_Conditions_STA6707_07132023.mis, col=c('navyblue', 'yellow' ),
...
```
Figure 3: Missing data percentages per variable
...
plot_pattern(Chronic_Conditions_STA6707_07132023.mis)

```
Figure 4: Table of missing values present in each variable in dataset
